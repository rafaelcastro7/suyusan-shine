...
export function ServiceAreaMap({ className = "" }: { className?: string }) {
  return (
    <div className={`grid lg:grid-cols-2 gap-8 items-stretch ${className}`}>
      <div className="overflow-hidden rounded-[var(--radius-bento)] border border-border min-h-[20rem]">
        <iframe
      ...
      <div className="rounded-[var(--radius-bento)] border border-border bg-card p-8">
